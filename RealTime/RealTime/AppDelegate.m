...
//
#define IPAddress @"http://153.35.178.43:8989/dlyw3.0/ServiceController/"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //监测网络连接
    [[NetWorkTool defaultManager] NetWorkStatus];
    [NetWorkTool defaultManager].baseURL =IPAddress;
    return YES;
}
